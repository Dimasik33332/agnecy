...
function addMyScript(){
	wp_enqueue_style('output', get_template_directory_uri() . '/dist/output.css', array(), null , 'all' );
	wp_enqueue_script('jquery');
	wp_enqueue_script( 'newscript', get_template_directory_uri() . '/js/script.js', null, false );
}
add_action('wp_head_my', 'addMyScript');



// $handle = 'output';
// wp_register_style( $handle, get_stylesheet_directory_uri().'/dist/output.css', array(), '', true );
